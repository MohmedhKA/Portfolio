              ...
              <div className="project-card-content">
                ...
                <AnimatePresence>
                  {expanded === project.title && (
                    ...
                    >
                      <div className="project-card-expanded-inner">
                        {project.techStack && (
                          <div className="project-expand-row">
                            <span className="project-expand-label">Tech Stack</span>
                            <span className="project-expand-value">{project.techStack}</span>
                          </div>
                        )}
                        {project.learned && (
                          <div className="project-expand-row">
